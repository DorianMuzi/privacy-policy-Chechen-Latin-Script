...
Installation
Download the Chechen Latin Script extension from this link (add link if necessary).

Follow the installation instructions specific to your browser (e.g., Chrome, Firefox, etc.).

Enable the extension and start browsing pages containing Chechen text.
